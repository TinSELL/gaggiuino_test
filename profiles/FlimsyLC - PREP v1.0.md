*__这是准备 (PREP) 配置文件，用于设置初始温度。准备就绪后，请使用其中一个运行 (RUN) 配置文件进行萃取。__*
...
---
*Original text:*
*__This is the preparation profile, which is used to set the initial tempature. When ready, pull the shot with one of the RUN profiles.__*
